 ...
 * - Floating action button for global use.
 * - Sticky position in bottom-right corner.
 * - Includes expand-on-hover label.
 * - Customizable phone number and message.
 */
const WhatsAppButton = ({
  phoneNumber = "919000359717",
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-[9999] bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center group border-2 border-white/20"
    ...
    >
      ...
      <span className="max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-500 ease-in-out whitespace-nowrap font-bold text-sm">
        <span className="pl-2 pr-4">Chat with us</span>
      </span>
